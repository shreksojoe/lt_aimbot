...
product details:
if line has 0000x number
take the whole line minus the "Each" under UOM and price under Ammount at the end
Go to the next "Ship,Date:" and get the date after that (%d/%m/%Y)

address:
Under "Vendor:,Ship,To:"
Ater "ROLL,PRODUCTS,INC.,"
Above "Ship-To,Qualifier:,"
Print \n for new line
...
3. Add a marker in the csv which product is Stock and which is Custom
    ...
    If you have multiple customs on a PO, you may duplicate
...
5. Enter in the Ship Date (in the description box on the PO, should match exactly) 
...
20. Click to the "Address" tab
21. Press on "Location"
22. Press the "State" column header
23. Double click the "Grainger Dropship Acct"
23. Fill in the Address as listed in the PO
   Leave fields: "Attention, Email", "Instructions, Via", "Ship Via", and "Freight Acct. No." near the bottom as they are
